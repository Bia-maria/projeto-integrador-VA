...
A aplicação foi construída utilizando a linguagem Kotlin, Android Studio, arquitetura simples em camadas, e ViewBinding para facilitar o acesso aos elementos visuais.
...
SQLite / Room (conforme implementação)
...
git clone https://github.com/Bia-maria/projeto-integrador-VA.git
